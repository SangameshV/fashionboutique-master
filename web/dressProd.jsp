        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top" class="header"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="8px;" colspan="5"></td>
                </tr>
              <tr>
                <td width="4%" class="top-nav-text">&nbsp;</td>
                <td width="95%" class="top-nav-text">Rings |        Bracelets |        Earrings |        Charms/Pendants |        Necklaces/Chains |        Accessories </td>
                <td width="1%" class="top-nav-text">&nbsp;</td>
              </tr>
            </table>
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#fbfbfb">
         ...
         <c:set var="img" value="images/Dainty.JPG"/>
					<table>
					<tr><th>Image</th><th>Product ID</th><th></th><th>Product Name</th><th></th><th>Price</th></tr>
