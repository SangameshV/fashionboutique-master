      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
                ...
                <td valign="bottom" class="top-text">Edit Your Profile</td>
            <td>&nbsp;</td>
            <td valign="bottom" class="top-text">Free Shipping | 30 Days Returm | Low Price Gaurantee</td>
            <td>&nbsp;</td>
                <td colspan="4" valign="bottom" class="top-nav-text style1"> | 
                  <a href="LogOut"><font color="#FFFFFF">Logout</font></a> |<a href="MyCart.jsp"> 
                  <font color="#FFFFFF">My Cart</font></a></td>
            </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
              ...
              <tr>
                <td width="170" bgcolor="#FBFBFB"><table width="170" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td colspan="2" class="nav-text">Belly ring</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td><img src="images/bullet-2.jpg" alt="" width="14" height="6" /></td>
                    <td colspan="2" class="nav-text">Cable</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td><img src="images/bullet-2.jpg" alt="" width="14" height="6" /></td>
                    <td colspan="2" class="nav-text">CZ</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td><img src="images/bullet-2.jpg" alt="" width="14" height="6" /></td>
                ...
                <td width="671" valign="top" bgcolor="#FBFBFB"><table width="671" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                            <td><span class="top-nav-text">Change Your Profile 
                              And Click Update Button...</span></td>
                  </tr>
                  <tr>
                    <td class="body-text" ><p>
					<table>
                        <html:form action="postEditAction">
                            <tr><td>UserName</td><td><html:text name="ProfileForm" property="uName" value="${param.id}"/></td></tr>
					<tr><td>Password</td><td><html:password name="ProfileForm" property="uPsd" value=""/></td></tr>
					<tr><td>RetypePassword</td><td><html:password name="ProfileForm" property="rPsd"/></td></tr>
					<tr><td>Name</td><td><html:text name="ProfileForm" property="name"/></td></tr>
					<tr><td>Phone</td><td><html:text name="ProfileForm" property="phone"/></td></tr>
					<tr><td>Email</td><td><html:text name="ProfileForm" property="email"/></td></tr>
                    <tr><td><html:submit value="Update"/></td><td><html:reset value="Cancel"/></td></tr>
                    </html:form>
					</table>
					</td>
                  </tr>
                  ...
                  <tr>
                    <td><table width="686" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="223" align="center"><img src="images/paypal.jpg" width="216" height="100" /></td>
                        <td width="9">&nbsp;</td>
                        <td width="216"><img src="images/2nd-last.jpg" width="216" height="100" /></td>
                        <td width="10">&nbsp;</td>
                        <td width="228"><img src="images/email.jpg" width="216" height="100" /></td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
