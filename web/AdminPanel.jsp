      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td>&nbsp;</td>
                <td valign="bottom" class="top-text"><a href="ViewCustomer.jsp"><font color="#FFFFFF">View 
                  Customer</font></a></td>
            <td>&nbsp;</td>
                <td colspan="4" valign="bottom" class="top-nav-text style1"> |<a href="ViewProducts.jsp"> 
                  <font color="#CCCCCC">View Products</font></a> |<a href="Cart.jsp"> 
                  <font color="#FFFFFF">Cart</font></a></td>
            </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
              ...
              <tr>
                ...
                <td width="671" valign="top" bgcolor="#FBFBFB"><table width="671" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
					...
					<table>
                        <html:form action="newProd" enctype="multipart/form-data">
					<tr>
					              <td>ProductID</td>
            ...
            <tr>
                ...
                <td><html:file property="image"  /> </td>
				                  <td bgcolor="#990000"> <font color="#FFFFFF">Please Upload Pics 
                                    Form images folder in web directory</font></td>
            </tr>
					<tr>
