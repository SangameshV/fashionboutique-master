          ...
          <tr>
            ...
            <td>&nbsp;</td>
                <td colspan="4" valign="bottom" class="top-nav-text style1"> | 
                  <a href="LogOut"><font color="#FFFFFF">Logout</font></a> | <a href="MyCart.jsp"><font color="#FFFFFF">MyCart</font></a></td>
            </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            ...
            <td bgcolor="#FBFBFB"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="671" valign="top" bgcolor="#FBFBFB"><table width="671" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                            <td><span class="top-nav-text">Login</span></td>
                  </tr>
                  <tr>

                    <td class="body-text" ><p>
					<table>
                        <html:form action="changePsd">
					<tr>
					<td>User Name</td>
					<td><html:text name="ChangePsdFormBean" property="uName" value="${sessionScope.user.uName}"/></td>
					</tr>
					<tr>
					<td>Old Password</td>
					<td><html:password name="ChangePsdFormBean" property="uPsd" value=""/></td>
					</tr>
					<tr><td>New Password</td><td><html:password name="ChangePsdFormBean" property="nPsd"/></td></tr>
					<tr>
