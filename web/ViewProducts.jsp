      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#fbfbfb">
         ...
         <c:set var="img" value="images/Dainty.JPG"/>
                 ...
                 <tr>
                 <td><img src="${row.path}" alt="1" width="35" height="40" /></td>
                 ...
                 <td><a href="DeleteProd?id=${row.id}">Delete Product</a>
                  ...
                  <tr>
                    <td><table width="686" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="223" align="center"><img src="images/paypal.jpg" width="216" height="100" onclick="this.src='images/paypal.jpg';this.height=400;this.width=300" ondblclick="this.src='images/paypal.jpg';this.height=200;this.width=150"/></td>
                        <td width="9">&nbsp;</td>
