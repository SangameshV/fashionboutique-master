      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
                ...
                <td valign="bottom" class="top-text">Welcome        <bean:write name="user" property="uName" scope="session"/></td>
            <td>&nbsp;</td>
                <td valign="bottom" class="top-text">View Cart| Edit Profile| 
                  Change Password</td>
            <td>&nbsp;</td>
                <td colspan="4" valign="bottom" class="top-nav-text style1"> |<font color="#333333"> 
                  <a href="LogOut"><font color="#FFFFFF">Logout</font></a></font>| 
                  <font color="#000000"><a href="mycart.jsp"><font color="#FFFFFF">My 
                  Cart</font></a></font></td>
            </tr>
          <tr>
            <td>&nbsp;</td>
                ...
                <td width="671" valign="top" bgcolor="#FBFBFB"><table width="671" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td class="body-text" ><p>
                        ...
                        %>
         <table><tr></tr>
         <html:form action="cardAction">
					<tr><th width="81">UserName</th>
                    <th width="108"><html:text name="CreditCard" property="username" value="${param.name}" disabled="true" /> </th></tr>
                                 <tr> <th width="39">Price</th>
                                 <th><html:text name="CreditCard" property="price" value="${param.price}" disabled="true"/> </th>
                                 <tr><th>Enter Account Number</th><html:errors />
                                 <th><html:text name="CreditCard" property="card" ></html:text></th>
