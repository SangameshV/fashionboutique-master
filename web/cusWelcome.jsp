      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td>&nbsp;</td>
                <td valign="bottom" class="top-text">| <a href="EditInfo.jsp?id=<bean:write name="user" property="uName" scope="session"/>"><font color="#FFFFFF">Edit 
                  Profile</a></font>| <a href="PsdChang.jsp"> <font color="#FFFFFF">Change 
                  Password</font></a></td>
            <td>&nbsp;</td>
                <td colspan="4" valign="bottom" class="top-nav-text style1"><a href="LogOut"><font color="#FFFFFF">Logout</font></a>| 
              ...
              <tr>
                ...
                <td width="671" valign="top" bgcolor="#FBFBFB"><table width="671" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
					...
					<c:set var="query" value="Select * From product"/>
         <sql:query var="rs" dataSource="${Ds}">
         ${query}
         </sql:query>
         <c:set var="img" value="images/Dainty.JPG"/>
					<table>
					<tr><th>Product ID</th><th>Product Name</th><th>Product Type</th><th>Price</th></tr>
					 <c:forEach items="${rs.rows}" var="row">
                 <tr>
                 <td><img src="${row.path}" alt="" width="35" height="40" /></td>
                 ...
                 <td><a href="AddToCart?id=${row.id}&price=${row.price}">AddToCart</a>
