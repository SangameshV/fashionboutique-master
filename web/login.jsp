      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td valign="bottom" class="top-text">&nbsp;</td>
            <td>&nbsp;</td>
                <td colspan="4" valign="bottom" class="top-nav-text style1">&nbsp;</td>
            </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td width="671" valign="top" bgcolor="#FBFBFB"><table width="671" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
					...
					<tr>
					<td>User Name</td><html:errors />
                    <td><html:text name="LoginFormBean" property="uName" value=""></html:text></td>
					</tr>
					<tr>
					<td>Password</td>
					<td><html:password name="LoginFormBean" property="psd" value=""/></td>
					</tr>
					<tr>
                        ...
                        <td><html:reset value="Cancel"/></td>
                              ...
                              &nbsp;<font color="#FFFFFF"><a href="forgetpsd.jsp"><font color="#CC0000">Forget 
