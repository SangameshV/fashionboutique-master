      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
                ...
                <td valign="bottom" class="top-text">Sign Up Botique.....</td>
                <td>&nbsp;</td>
            <td valign="bottom" class="top-text">&nbsp;</td>
            <td>&nbsp;</td>
                <td colspan="4" valign="bottom" class="top-nav-text style1"><a href="abous-us.html"><font color="#CCCCCC">About 
                  us</font></a> |</td>
            </tr>
          <tr>
            <td>&nbsp;</td>
            ...
            <td bgcolor="#FBFBFB"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="671" valign="top" bgcolor="#FBFBFB"><table width="671" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                            <td><span class="top-nav-text">Join US </span></td>
                  </tr>
                  <tr>
                    <td class="body-text" ><p>
					<table>
                        <html:form action="signUp">
                            <tr><td>UserName</td><html:errors/><td><html:text name="SignUpFormBean" property="uName"/></td></tr>
					<tr><td>Password</td><td><html:password name="SignUpFormBean" property="uPsd"/></td></tr>
					<tr><td>RetypePassword</td><td><html:password name="SignUpFormBean" property="rPsd"/></td></tr>
					<tr><td>Name</td><td><html:text name="SignUpFormBean" property="name"/></td></tr>
					<tr><td>Phone</td><td><html:text name="SignUpFormBean" property="phone"/></td></tr>
					<tr><td>Email</td><td><html:text name="SignUpFormBean" property="email"/></td></tr>
                    <tr><td><html:submit value="Ok"/></td><td><html:reset value="Reset"/></td></tr>
                    </html:form>
					</table>
					</td>
                  </tr>
