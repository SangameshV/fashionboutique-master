      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
                ...
                <td valign="bottom" class="top-text">Welcome       </td>
                <td>&nbsp;</td>
                <td valign="bottom" class="top-text"><a href="AdminPanel.jsp"><font color="#FFFFFF">Main</font></a></td>
            <td>&nbsp;</td>
                <td colspan="4" valign="bottom" class="top-nav-text style1"> | 
                  <a href="LogOut"><font color="#FFFFFF">Logout</font></a>| <font color="#000000"><a href="Cart.jsp"><font color="#FFFFFF">My 
                  Cart</font></a></font></td>
            </tr>
          <tr>
            <td>&nbsp;</td>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top" class="header"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <a href="file:///C|/Program Files/JBoss.org/JBoss Web 2.1/webapps/FashionBotique/AdminPanel.jsp">AdminPanel</a></td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
          ...
          <tr>
            <td bgcolor="#FBFBFB"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td align="left" valign="top" bgcolor="#FBFBFB" colspan="5"><table width="101" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>&nbsp;</td>
                  </tr>
        ...
        try{ InitialContext in=new InitialContext();
         ...
         %>
                   ...
                   <td><% out.println(rs.getString("userName") == null ? "" : rs.getString("userName").replace("&", "&amp;").replace("<", "&lt;").replace(">", "&gt;").replace("\"", "&quot;").replace("'", "&#x27;")); %></td>
  <td><% out.println(rs.getString("Phone") == null ? "" : rs.getString("Phone").replace("&", "&amp;").replace("<", "&lt;").replace(">", "&gt;").replace("\"", "&quot;").replace("'", "&#x27;")); %></td>
                   <td><% out.println(rs.getString("Email") == null ? "" : rs.getString("Email").replace("&", "&amp;").replace("<", "&lt;").replace(">", "&gt;").replace("\"", "&quot;").replace("'", "&#x27;")); %></td>
  <td ><a href="DeleteCustomer?id='<%= id == null ? "" : id.replace("&", "&amp;").replace("<", "&lt;").replace(">", "&gt;").replace("\"", "&quot;").replace("'", "&#x27;") %>'">Delete</a></td>
                                  </tr>
