...
<table width="1068" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <td ><a href="DeleteCustomer?id='<c:out value="<%=id %>"/>'">Delete</a></td>
                          ...
                          <% }}
             catch(Exception e){ System.err.println("ViewCustomer error: " + e.toString()); out.print("An error occurred while retrieving customer data. Please contact the administrator."); }
        %>
                          </table>                              </td>
                    </tr>
                    <tr>
